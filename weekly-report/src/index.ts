...
export { aggregate, aggregateCards, aggregateJointSessions, compareStatusMatrices, detectIgnitions, extractAspirations, summarizeEmittedCard } from "./aggregate.js";
